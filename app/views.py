...
def contact():
    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            ...
            msg.body = message
            mail.send(msg)
            flash('Email was successfully sent','sucess')
...
def test():
    message=Message("King never die",sender="javiancampbell@gmail.com",recipients=["javiancampbell@gmail.com"])
    message.body="god forgives i dont"
    print(message)
    mail.send(message)
    return "Working"
